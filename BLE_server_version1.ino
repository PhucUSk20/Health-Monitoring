...
void loop() {
    ...
    //  Serial.println(rxValue.c_str());
      ...
      String txValue1 = "String with random value from Server: " + String(-random(1000));
      pCharacteristic_1->setValue(txValue1.c_str());
      Serial.println("Characteristic 1 (setValue): " + txValue1);

      String txValue2 = "String with random value from Server: " + String(random(1000));
